// AngularJS sends $http.post as application/json
// Django expects x-www-form-urlencoded
// This config will fix the disparity
...
(function () {
    ...
    encoding.$inject = ['$httpProvider'];

    function encoding( $httpProvider ) {
